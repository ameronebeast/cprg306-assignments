...
const LandingPage = () => {
  ...
  return (
    <div className=" bg-gray-950 text-white h-screen flex content-center m-auto justify-around  flex-row align-middle w-full text-center">
      {user ? (
        <div className="m-4">
          ...
          <button onClick={handleSignOut} className="bg-blue-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded mt-4">Logout</button>
